...
public class WxPaymentController {
    ...
    public Dto createCode(@PathVariable String orderNo) {
        try {
            ...
            //异步通知的URL地址。
            data.put("notify_url", "http://itriphjx.free.idcfengye.com/itriptrade/api/wx/notify");
            ...
            //2、转成XML请求微信支付平台   key为:  API密钥"2ab9071b06b9f739b950ddb41db2690d"
    ...
    @ResponseBody
    public Dto queryOederStatus(@PathVariable String orderNO){
//将订单查询出来
        try{
            ItripHotelOrder order = orderService.loadItripHotelOrder(orderNO);
